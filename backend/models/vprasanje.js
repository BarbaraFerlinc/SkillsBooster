    ...
    static async dodaj(vprasanje, tip) {
        try {
            ...
            if (this.getById(id) == undefined) {
                ...
                return { message: 'Neuspešno dodano vprašanje', vprasanje: undefined };
            }
        } catch (error) {
    ...
    static async spremeni(id, vprasanje, tip) {
        try {
            if (this.getById(id) != undefined) {
                ...
                return { message: 'Neuspešna posodobitev vprašanja', vprasanje: undefined };
            }
        } catch (error) {
    ...
    static async odstraniOdgovor(id, odgovorId) {
        try {
            if (this.getById(id) != undefined) {
                ...
                return { message: 'Vprašanje ne obstaja', vprasanje: undefined };
            }
        } catch (error) {
            throw new Error('Napaka pri pridobivanju vprašanja iz baze: ' + error.message);
        }
