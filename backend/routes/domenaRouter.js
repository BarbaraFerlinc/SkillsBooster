...
router.post('/dodaj-link', domenaController.dodajLinkDomena);
router.post('/linki', domenaController.najdiLinkeDomena);
router.post('/odstrani-link', domenaController.odstraniLinkDomena);
