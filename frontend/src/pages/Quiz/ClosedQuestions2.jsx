...
function ClosedQuestion2({ question, options, onQuestionChange, onOptionChange, addOption, onAnswerTypeChange, error }) {
    return (
        <div>
            <div className="mb-4">
...
export default ClosedQuestion2;
